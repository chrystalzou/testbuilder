...
var detectNetwork = function(cardNumber) {
  ...
  if ((prefix === 38 || prefix === 39) && (cardNumber.length === 14)) {
    ...
    network = "MasterCard";
  } else if (((Number(cardNumber.slice(0,4))) === 6011 || (Number(cardNumber.slice(0,4)) >= 644 && Number(cardNumber.slice(0,4)) <= 649) || prefix === 65) && (cardNumber.length === 16 || cardNumber.length === 19)) {
  	network = "Discover";
